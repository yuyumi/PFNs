"""
Bayesian TinyPFN with Prior-Data Negative Log-Likelihood Loss

Uses the proper Bayesian loss: ℓ_θ = E_{D∪{x,y}∼p(D)}[− log q_θ(y|x, D)]
This is much simpler and more appropriate for comparing architectures.
"""
...
class BayesianTinyPFN(nn.Module):
    """
    TinyPFN with proper cell-level representations and Bayesian PD-NLL loss.
...
def test_bayesian_tiny_pfn():
    """Test the Bayesian TinyPFN implementation."""
    print("Testing Bayesian TinyPFN with PD-NLL loss...")
    
    # Create model
    model = BayesianTinyPFN(num_features=10, d_model=256, n_heads=4)
    ...
    print("✓ Bayesian TinyPFN test passed!")
